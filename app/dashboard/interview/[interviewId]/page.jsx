  ...
  return (
    <div className='my-10 '>
      ...
      <div className=' flex flex-col gap-5 my-5 '>
        ...
        <h2 className='flex gap-2 items-cente text-yellow-500'><Lightbulb/><strong>Information</strong></h2>  
      ...
      <div>
        ...
        <Button variant="ghost" className="w-full" onClick={()=>setWebCamEnabled(true)}><strong>Enable Webcam and Microphone</strong></Button>
        </>
